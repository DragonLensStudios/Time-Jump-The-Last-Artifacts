...
namespace PXE.Scripts.Core.Debug_Console.Editor
{
	[CustomEditor(typeof( DebugLogManager ) )]
	public class DebugLogManagerEditor : ObjectControllerEditor
	{
		...
		private SerializedProperty autocompleteBinding;
		...
		protected DebugLogManager manager;
		...
		private void OnEnable()
		{
			...
			autocompleteBinding = serializedObject.FindProperty( "autocompleteBinding" );
#else
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.LabelField("Autocomplete Binding");
			DrawSubProperty( autocompleteBinding );
